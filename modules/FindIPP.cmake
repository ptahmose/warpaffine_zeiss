...
find_path(IPP_INCLUDE_DIR
        ipp.h
        PATHS ${IPP_ROOT_DIR}/include/ipp)
find_path(IPP_INCLUDE_DIR
        ipp.h
        PATHS ${IPP_ROOT_DIR}/include)
find_path(IPP_INCLUDE_DIR
        ipp.h
        PATHS ${IPP_ROOT_DIR}/build/native/include)
...
if(IPP_FOUND AND NOT IPP_NOTFOUND)
    ...
    message(STATUS "Found IPP libraries in: ${IPP_LIBRARIES} ; Headers: ${IPP_INCLUDE_DIR}")
else()
